...
### 当Arraylist和LinkedList存相同数量的数据，哪个占用内存空间更大
...
#### spark-sql的工作原理 && spark-sql和spark-core有什么关系
...
#### 之后有没有继续看源码，去解决工作中的一些问题

### Redis

#### redis分布式原理，他是怎么样实现分布式的
